...
return t+(n[1]?n:"0"+n[0])+(o[1]?o:"0"+o[0])},p=new Date,v=0,m=h(p),_=h(new Date((new Date).setDate(p.getDate()-30))),y=h(new Date((new Date).setDate(p.getDate()-180))),S=h(new Date(p.getFullYear(),p.getMonth(),1)),k=document.title,b=window.location.href.indexOf("kwp_4=")>0,E=0,D=null,C=function(){return localStorage&&localStorage.keyweeHistory?JSON.parse(localStorage.keyweeHistory):{}},q=function(e){localStorage&&(localStorage.keyweeHistory=JSON.stringify(e))},T=function(e){var t=C(),n=t[e]
return n||{date:e}},H=function(e,t){var n=C()
n[e]=t,q(n)},O=function(e){var t,n=T(e||m),i=o((new Date-p)/6e4),r=F()
return r>E&&(E=r),n.categories||(n.categories={}),n.categories[s]||(n.categories[s]={articles_read:0,keywee_articles_read:0,time_spent:0,category:s}),t=n.categories[s],t.last_visited_article!=k&&(t.articles_read++,b&&t.keywee_articles_read++,t.last_visited_article=k),t.time_spent=t.time_spent-v+i,v=i,H(e||m,n),n},K=function(e,t,n){return Object.keys(e).filter(function(e){return e>=t&&(!n||n>=e)})},P=function(e,t){var n=C()
return K(n,e,t).map(function(e){return n[e]})},x=function(){var e=null
return localStorage&&localStorage.keywee_oldest_visit_date&&(e=localStorage.keywee_oldest_visit_date),e},N=function(){var e=C(),t=K(e,y,_),n=x()
...
n>S&&(n=S),e&&(n=e),t=P(n),t.forEach(function(e){o[e.date]=e}),q(o)},V=function(e){return s&&(e["cat-"+s]=1,e.category=s),l&&(e["sect-"+l]=1,e.section=l),u&&(e["sub-sect-"+u]=1,e.sub_section=u),e},j=function(){var e={tsop:v,lop:E}
return V(e)},M=function(e){this.customizations.isCore?this.customizations.isCore.bind(this)(e):e.lov&&e.noad30>=2&&(e.core=1)},W=function(){var e=P(_),t=P(S),n=function(e){return 1==e.length?a(e[0].categories):e.reduce(function(e,t){return e.concat(a(t.categories))},[])},r=function(e,t){return 1==e.length?e[0][t]:e.reduce(function(e,n){return e+n[t]},0)},c=function(e){return e.split("_").map(function(e){return e[0]}).join("")},l=["articles_read","keywee_articles_read","time_spent"],u=n(e),g=n(t),f=u.filter(function(e){return e.category==s}),w=g.filter(function(e){return e.category==s}),h=e.length,p=t.length,v={noad30:[3,5,10],noadic30:[3,5,10],ar30d:[3,5,10],kar30d:[3,5,10],ts30d:[30,60,180]},m={noad30:h,noadic30:f.length,noadiccm:w.length,noadcm:p}
...
break}}),this.customEventData&&(m=i(m,this.customEventData)),this.updateIsCoreAudience(m),m},F=function(){var e=null,t=window.pageYOffset||document.documentElement.scrollTop,n=document.body,i=document.documentElement,r=Math.max(n.scrollHeight,n.offsetHeight,i.clientHeight,i.scrollHeight,i.offsetHeight),a=window.innerHeight
return g.getArticleContainerHeight&&(e=g.getArticleContainerHeight()),e&&(r=e),o(Math.min(100,t/(r-a)*100))},I=function(){var e=F(),t=null,n=e!=D,i=o((new Date-p)/6e4),r=i>30
n&&!r&&(O(),t=this.getPeriodicEventToSend(),f("trackCustom","KWCEPA",t),D=e)},L=function(){var e=null
O(),e=this.getEventToSend(),f("trackCustom","KWCEPV",e),window.fbq&&fbq("track","PageView"),window.snowplowKW&&window.snowplowKW("trackPageView")},B=3,z=function(e){var t=this
if(e.waitFor&&!e.waitFor()&&B>0)return B-=1,void setTimeout(this.init,5e3,e)
try{this.customizations=e,this.customEventData={},g=e,N(),d=x(),g.getCategories&&(this.categories=g.getCategories(),this.categories.length>0&&(s=r(this.categories[0])),this.categories.length>1&&(l=r(this.categories[1])),this.categories.length>2&&(u=r(this.categories[2]))),g.eventListners&&g.eventListners.forEach(function(e){e.bind(t)()}),s&&(w(),A(),this.sendPageViewEvent(),setInterval(I.bind(this),3e4))}catch(n){console.log("Exception:"+n),console.log(n.stack)}},G={}
return window[e]=G,G.last_30_days_date_str=_,G.getDataBetweensDates=P,G.updateIsCoreAudience=M,G.getKeyweeHistory=C,G.updateData=O,G.today_str=m,G.getEventToSend=W,G.getPeriodicEventToSend=j,G.cleanOldData=A,G.sendPeriodicEvent=I,G.sendPageViewEvent=L,G.sendViewContentEvent=w,G.getLatestOldVisit=x,G.setLatestOldVisit=N,G.sendEvent=f,G.product_id=c,G.init=z,G}("Keywee"),function(){!function(e,t,n,o,i,r,a){e.fbq||(i=e.fbq=function(){i.callMethod?i.callMethod.apply(i,arguments):i.queue.push(arguments)},e._fbq||(e._fbq=i),i.push=i,i.loaded=!0,i.version="2.0",i.queue=[],r=t.createElement(n),r.async=!0,r.src=o,a=t.getElementsByTagName(n)[0],a.parentNode.insertBefore(r,a))}(window,document,"script","//connect.facebook.net/en_US/fbevents.js"),fbq("init","948912858484145")}(),function(e,t,n,o,i,r,a){e[i]||(e.GlobalSnowplowNamespace=e.GlobalSnowplowNamespace||[],e.GlobalSnowplowNamespace.push(i),e[i]=function(){(e[i].q=e[i].q||[]).push(arguments)},e[i].q=e[i].q||[],r=t.createElement(n),a=t.getElementsByTagName(n)[0],r.async=1,r.src=o,a.parentNode.insertBefore(r,a))}(window,document,"script","//dc8xl0ndzn2cb.cloudfront.net/sp.js","snowplowKW"),function(){function e(){var e=function(e,t,n,o){var i,r
if(n){var a=new Date
...
window.snowplowKW("newTracker","cf","pixel.keywee.co",{appId:"37",cookieDomain:t}),e(),window.snowplowKW("enableActivityTracking",30,30)}(),function(){var e=function(){var e=[]
if(CategorySource=$('meta[name="tax:source"]').attr("content"),FirstSubject=$('meta[name="tax:firstSubjectAncestor"]').attr("content"),CategorySource)e.push(CategorySource,FirstSubject)
else{var t=window.location.host,n=t.split("."),o=n[0]
e.push(o)}return e}
